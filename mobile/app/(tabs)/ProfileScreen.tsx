...
export default function ProfileScreen() {
  ...
  const handleSave = () => {
    Alert.alert("設定を保存しました", `完了度 ${progress}% で保存されました。`);
  };
...
const styles = StyleSheet.create({
  ...
  footer: { position: 'absolute', bottom: 0, left: 0, right: 0, padding: 20, paddingBottom: Platform.OS === 'ios' ? 40 : 20, backgroundColor: 'rgba(255,255,255,0.95)', borderTopWidth: 1, borderTopColor: '#E5E5EA', zIndex: 999 },
  saveButton: { backgroundColor: '#007AFF', height: 56, borderRadius: 16, justifyContent: 'center', alignItems: 'center', shadowColor: '#007AFF', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 8, elevation: 5 },
